/**
 * Config gameplay lato server (autorevole).
 *
 * Per cambiare dinamiche di gioco (velocita', danni, spawn, dimensioni arena),
 * modifica questo file.
 */
const characterTypes = require('./characterTypes.json');
...
const activeMapId = process.env.MAP_ID || fallbackMapId;
const activeMap = maps[activeMapId] || maps[fallbackMapId] || {};
const activeWorld = activeMap.world || { width: 2400, height: 1400 };
...
module.exports = {
  ...
  maps,
  map: {
    id: maps[activeMapId] ? activeMapId : fallbackMapId,
